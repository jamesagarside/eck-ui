// Elastic Maps Server Create Page
...
function buildSpec(data: FormData): ElasticMapsServer {
  return {
...
export function MapsCreatePage() {
  ...
  const createMutation = useCreateElasticMapsServer();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(`/maps/${formData.namespace}/${formData.name}`);
    } catch (err) {
      setSubmitError(err instanceof Error ? err.message : 'Failed to create Elastic Maps Server');
    }
  };
        ...
        <EuiForm component="form" onSubmit={handleSubmit}>
          ...
          <EuiPanel>
            ...
            <EuiFlexGroup>
              <EuiFlexItem>
                <EuiFormRow
                  label="Name"
                  helpText="Unique name for this Elastic Maps Server instance"
                  isInvalid={!!errors.name}
                  error={errors.name}
                >
                  <EuiFieldText
                    placeholder="my-maps-server"
                    value={formData.name}
          ...
          <EuiFlexGroup justifyContent="flexEnd">
            <EuiFlexItem grow={false}>
              <EuiButtonEmpty onClick={() => navigate('/maps')}>Cancel</EuiButtonEmpty>
            </EuiFlexItem>
            <EuiFlexItem grow={false}>
              <EuiButton
                type="submit"
  ...
  return (
    <EuiPageTemplate>
      <EuiPageHeader
        pageTitle="Create Elastic Maps Server"
        breadcrumbs={[
          {
        ...
        description="Deploy a new Elastic Maps Server instance"
      />
